                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="insapp_price_mensuel"
                                            placeholder="50.00 <?php echo get_woocommerce_currency_symbol() ;?>"
                                            required />
                                    </div>
                                    <!-- input -->
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="insapp_price_mensuel_promo"
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input name='inspp_list_sub' value='tag1, tag2'> 
                            </div>
                        </div>
                    </div>
                </div>
