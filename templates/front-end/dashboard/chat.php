                            ...
                            <div class="tab-content" id="tabContent">
                                ...
                                <div class="tab-pane fade show active" id="recent" role="tabpanel"
                                    ...
                                    <ul class="list-unstyled contacts-list">
                                        ...
                                        <li class="py-3 px-4 chat-item contacts-link" date-r="<?php _e($user_id2) ?>"date-id="<?php _e($conver_id) ?>">
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <a href="#!" class="text-inherit ">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class=" ms-2">
                                                            <span class="mb-0 ">  <?php echo $name2 ?> </span>
            ...
            <div class="col-xxl-8 col-xl-8 col-md-12 col-12">
                ...
                <div class="chat-body w-100 h-100">
                    <div class="card-header sticky-top insapp_discussion_space">
                        ...
                        <div class="card-body" id="insapp_conversation_list" data-id="<?php _e($last_conversation ) ?>" style="height: 650px; overflow:auto">
                            ...
                            <div class="d-flex  mb-4">
                                ...
                                <div class=" ms-3">
                                    <small>
                                        <span class="username"> <?php _e($name2) ?> </span> , <?php _e($time) ?>
                                    </small>
                                    <div class="d-flex">
                                        <div class="card mt-2 rounded-top-md-left-0 border">
                                            <div class="card-body p-2">
                                                <p class="mb-0 text-dark"><?php  _e($message) ?></p>
                                            </div>
                                        </div>
                                        <div class="ms-2 mt-2">
                        ...
                        <div class="mt-1">
                            <form id="chatinput-form">
                                <div class="position-relative">
                                    <textarea rows="1" cols="" class="form-control" placeholder="Saisir votre message"
                                        id="insapp_chat_input"></textarea>
                                </div>
                                <div class="position-absolute end-0 top-0 mt-4 py-1 me-4">
                                    <button type="submit"
                                        class="chat_messageinput-group-addon btn btn-primary">Envoyer</button>
