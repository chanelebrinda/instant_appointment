...
?>
       ...
       <h3><?php _e('Agenda')?></h3>
         ...
         <div class="row ia_agenda_step">
             <div class=" offset-md-2 col-md-8 col-8 mb-5">
                <!-- card -->
        ...
        <div class="modal fade" id="insapp_creneauModal" tabindex="-1" aria-labelledby="eventModalLabel" aria-modal="true" role="dialog" >
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <button type="button" class="btn-close" data-bs-dilgiss="modal" aria-label="Fermer"></button>
                    </div>
                    ...
                    <form name="insapp_creneauForm" id="insapp_creneauForm" data-gtm-form-interact-id="0">
                            <div  >
                                ...
                                <div class="row my-5"> 
                                    ...
                                    <div class="col-3">
                                    <button type="button" class="btn btn-secondary btn-md" data-bs-dilgiss="modal">Fermer</button>
                                    </div> 
