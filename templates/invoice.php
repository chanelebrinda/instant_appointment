			...
			<div class="invoice-content-wrap">
												...
												<table class="invo-total-table">
													<tbody>
														...
														<tr class="invo-grand-total bottom-border" s>
															<td class="inter-700 sm-text primary-color hotel-sub" style="font-weight: 700; font-size: 18px;color:#00BAFF;padding-right: 10px;">Grand Total:</td>
				...
				<div class="agency-bottom-content"> 
					<div class="invo-note-wrap" style="display:inline">
						...
						<h3 class="inter-400 medium-font third-color note-desc mtb-0" style="display:inline">This is computer generated receipt and does not require physical signature.</h3>
					</div>
				</div>
			</div>
			</div>
